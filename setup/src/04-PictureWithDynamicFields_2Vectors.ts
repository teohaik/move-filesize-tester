...
const PTB_MAX_SIZE = 256000;
const PARAM_MAX_SIZE = 131000;
...
const updatePicData = async (initStartByte: number = 0, picId : string) => {
    ...
    }while (endByte < imageData.length && total <= PARAM_MAX_SIZE - step)
